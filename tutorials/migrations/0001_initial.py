# Generated by Django 5.1.2 on 2024-12-12 12:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default='Unallocated', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('Python', 'Python'), ('Java', 'Java'), ('C++', 'C++'), ('Scala', 'Scala'), ('R', 'R'), ('Javascript', 'Javascript'), ('Swift', 'Swift'), ('Go', 'Go')], max_length=100)),
